  ...
  <nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <div class="flex md:order-2 items-center">
        ...
        <button @click="$router.push('/cart')" type="button" class="relative inline-flex items-center p-3 text-sm font-medium text-center text-gray-800 rounded-full bg-gray-50 hover:bg-gray-200 dark:bg-blue-600 dark:hover:bg-blue-700 ml-2">
...
<!--        Avatar for profile -->
        <img src="../assets/images/avatar.jpg" class="w-10 h-10 rounded-full ml-2 cursor-pointer" alt="User Avatar">
