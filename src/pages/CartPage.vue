...
const increment = (input: HTMLInputElement) => {
  input.value = String(parseInt(input.value) + 1);
};

const decrement = (input: HTMLInputElement) => {
  if (parseInt(input.value) > 1) {
    input.value = String(parseInt(input.value) - 1);
  }
};

const deleteFromCart = (event: MouseEvent) => {
  const target = event.target as HTMLElement;
  const parent = target.closest('.space-y-6') as HTMLElement;
  parent.remove();
};
</script>
            ...
            <div
              ...
              <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                ...
                <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                  <a href="#" class="text-base font-medium text-gray-900 hover:underline dark:text-white">PC system All
                    in One APPLE iMac (2023) mqrq3ro/a, Apple M3, 24" Retina 4.5K, 8GB, SSD 256GB, 10-core GPU, Keyboard
                    layout INT</a>
          ...
          <div class="hidden xl:mt-8 xl:block">
            ...
            <div class="mt-6 grid grid-cols-3 gap-4 sm:mt-8">
              <div
                ...
                <div>
                  <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">iMac
                    27”</a>
              ...
              <div
                ...
                <div>
                  <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Playstation
                    5</a>
                  <p class="mt-2 text-base font-normal text-gray-500 dark:text-gray-400">This generation has some
                    improvements, including a longer continuous battery life.</p>
                </div>
